...
namespace glew
{
  ...
  public:
    ...
    static bool IsSupported (GLEW_GLES_FeatureSet feature) { return s_deviceConfig.m_featureSupported [feature]; }
...
GLEW_EXTERN_C void _glew_gles_glReadBuffer (GLenum src);
GLEW_EXTERN_C void _glew_gles_glDrawRangeElements (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void * indices);
GLEW_EXTERN_C void _glew_gles_glTexImage3D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void * pixels);
GLEW_EXTERN_C void _glew_gles_glTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void * pixels);
GLEW_EXTERN_C void _glew_gles_glCopyTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glCompressedTexImage3D (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void * data);
GLEW_EXTERN_C void _glew_gles_glCompressedTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void * data);
GLEW_EXTERN_C void _glew_gles_glGenQueries (GLsizei n, GLuint * ids);
GLEW_EXTERN_C void _glew_gles_glDeleteQueries (GLsizei n, const GLuint * ids);
GLEW_EXTERN_C GLboolean _glew_gles_glIsQuery (GLuint id);
GLEW_EXTERN_C void _glew_gles_glBeginQuery (GLenum target, GLuint id);
GLEW_EXTERN_C void _glew_gles_glEndQuery (GLenum target);
GLEW_EXTERN_C void _glew_gles_glGetQueryiv (GLenum target, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetQueryObjectuiv (GLuint id, GLenum pname, GLuint * params);
GLEW_EXTERN_C GLboolean _glew_gles_glUnmapBuffer (GLenum target);
GLEW_EXTERN_C void _glew_gles_glGetBufferPointerv (GLenum target, GLenum pname, void ** params);
GLEW_EXTERN_C void _glew_gles_glDrawBuffers (GLsizei n, const GLenum * bufs);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix2x3fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix3x2fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix2x4fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix4x2fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix3x4fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix4x3fv (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glBlitFramebuffer (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
GLEW_EXTERN_C void _glew_gles_glRenderbufferStorageMultisample (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glFramebufferTextureLayer (GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer);
GLEW_EXTERN_C void * _glew_gles_glMapBufferRange (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
GLEW_EXTERN_C void _glew_gles_glFlushMappedBufferRange (GLenum target, GLintptr offset, GLsizeiptr length);
GLEW_EXTERN_C void _glew_gles_glBindVertexArray (GLuint array);
GLEW_EXTERN_C void _glew_gles_glDeleteVertexArrays (GLsizei n, const GLuint * arrays);
GLEW_EXTERN_C void _glew_gles_glGenVertexArrays (GLsizei n, GLuint * arrays);
GLEW_EXTERN_C GLboolean _glew_gles_glIsVertexArray (GLuint array);
GLEW_EXTERN_C void _glew_gles_glGetIntegeri_v (GLenum target, GLuint index, GLint * data);
GLEW_EXTERN_C void _glew_gles_glBeginTransformFeedback (GLenum primitiveMode);
GLEW_EXTERN_C void _glew_gles_glEndTransformFeedback ();
GLEW_EXTERN_C void _glew_gles_glBindBufferRange (GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
GLEW_EXTERN_C void _glew_gles_glBindBufferBase (GLenum target, GLuint index, GLuint buffer);
GLEW_EXTERN_C void _glew_gles_glTransformFeedbackVaryings (GLuint program, GLsizei count, const GLchar *const* varyings, GLenum bufferMode);
GLEW_EXTERN_C void _glew_gles_glGetTransformFeedbackVarying (GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLsizei * size, GLenum * type, GLchar * name);
GLEW_EXTERN_C void _glew_gles_glVertexAttribIPointer (GLuint index, GLint size, GLenum type, GLsizei stride, const void * pointer);
GLEW_EXTERN_C void _glew_gles_glGetVertexAttribIiv (GLuint index, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetVertexAttribIuiv (GLuint index, GLenum pname, GLuint * params);
GLEW_EXTERN_C void _glew_gles_glVertexAttribI4i (GLuint index, GLint x, GLint y, GLint z, GLint w);
GLEW_EXTERN_C void _glew_gles_glVertexAttribI4ui (GLuint index, GLuint x, GLuint y, GLuint z, GLuint w);
GLEW_EXTERN_C void _glew_gles_glVertexAttribI4iv (GLuint index, const GLint * v);
GLEW_EXTERN_C void _glew_gles_glVertexAttribI4uiv (GLuint index, const GLuint * v);
GLEW_EXTERN_C void _glew_gles_glGetUniformuiv (GLuint program, GLint location, GLuint * params);
GLEW_EXTERN_C GLint _glew_gles_glGetFragDataLocation (GLuint program, const GLchar * name);
GLEW_EXTERN_C void _glew_gles_glUniform1ui (GLint location, GLuint v0);
GLEW_EXTERN_C void _glew_gles_glUniform2ui (GLint location, GLuint v0, GLuint v1);
GLEW_EXTERN_C void _glew_gles_glUniform3ui (GLint location, GLuint v0, GLuint v1, GLuint v2);
GLEW_EXTERN_C void _glew_gles_glUniform4ui (GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
GLEW_EXTERN_C void _glew_gles_glUniform1uiv (GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glUniform2uiv (GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glUniform3uiv (GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glUniform4uiv (GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glClearBufferiv (GLenum buffer, GLint drawbuffer, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glClearBufferuiv (GLenum buffer, GLint drawbuffer, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glClearBufferfv (GLenum buffer, GLint drawbuffer, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glClearBufferfi (GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
GLEW_EXTERN_C const GLubyte * _glew_gles_glGetStringi (GLenum name, GLuint index);
GLEW_EXTERN_C void _glew_gles_glCopyBufferSubData (GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
GLEW_EXTERN_C void _glew_gles_glGetUniformIndices (GLuint program, GLsizei uniformCount, const GLchar *const* uniformNames, GLuint * uniformIndices);
GLEW_EXTERN_C void _glew_gles_glGetActiveUniformsiv (GLuint program, GLsizei uniformCount, const GLuint * uniformIndices, GLenum pname, GLint * params);
GLEW_EXTERN_C GLuint _glew_gles_glGetUniformBlockIndex (GLuint program, const GLchar * uniformBlockName);
GLEW_EXTERN_C void _glew_gles_glGetActiveUniformBlockiv (GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetActiveUniformBlockName (GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei * length, GLchar * uniformBlockName);
GLEW_EXTERN_C void _glew_gles_glUniformBlockBinding (GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding);
GLEW_EXTERN_C void _glew_gles_glDrawArraysInstanced (GLenum mode, GLint first, GLsizei count, GLsizei instancecount);
GLEW_EXTERN_C void _glew_gles_glDrawElementsInstanced (GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount);
GLEW_EXTERN_C GLsync _glew_gles_glFenceSync (GLenum condition, GLbitfield flags);
GLEW_EXTERN_C GLboolean _glew_gles_glIsSync (GLsync sync);
GLEW_EXTERN_C void _glew_gles_glDeleteSync (GLsync sync);
GLEW_EXTERN_C GLenum _glew_gles_glClientWaitSync (GLsync sync, GLbitfield flags, GLuint64 timeout);
GLEW_EXTERN_C void _glew_gles_glWaitSync (GLsync sync, GLbitfield flags, GLuint64 timeout);
GLEW_EXTERN_C void _glew_gles_glGetInteger64v (GLenum pname, GLint64 * data);
GLEW_EXTERN_C void _glew_gles_glGetSynciv (GLsync sync, GLenum pname, GLsizei bufSize, GLsizei * length, GLint * values);
GLEW_EXTERN_C void _glew_gles_glGetInteger64i_v (GLenum target, GLuint index, GLint64 * data);
GLEW_EXTERN_C void _glew_gles_glGetBufferParameteri64v (GLenum target, GLenum pname, GLint64 * params);
GLEW_EXTERN_C void _glew_gles_glGenSamplers (GLsizei count, GLuint * samplers);
GLEW_EXTERN_C void _glew_gles_glDeleteSamplers (GLsizei count, const GLuint * samplers);
GLEW_EXTERN_C GLboolean _glew_gles_glIsSampler (GLuint sampler);
GLEW_EXTERN_C void _glew_gles_glBindSampler (GLuint unit, GLuint sampler);
GLEW_EXTERN_C void _glew_gles_glSamplerParameteri (GLuint sampler, GLenum pname, GLint param);
GLEW_EXTERN_C void _glew_gles_glSamplerParameteriv (GLuint sampler, GLenum pname, const GLint * param);
GLEW_EXTERN_C void _glew_gles_glSamplerParameterf (GLuint sampler, GLenum pname, GLfloat param);
GLEW_EXTERN_C void _glew_gles_glSamplerParameterfv (GLuint sampler, GLenum pname, const GLfloat * param);
GLEW_EXTERN_C void _glew_gles_glGetSamplerParameteriv (GLuint sampler, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetSamplerParameterfv (GLuint sampler, GLenum pname, GLfloat * params);
GLEW_EXTERN_C void _glew_gles_glVertexAttribDivisor (GLuint index, GLuint divisor);
GLEW_EXTERN_C void _glew_gles_glBindTransformFeedback (GLenum target, GLuint id);
GLEW_EXTERN_C void _glew_gles_glDeleteTransformFeedbacks (GLsizei n, const GLuint * ids);
GLEW_EXTERN_C void _glew_gles_glGenTransformFeedbacks (GLsizei n, GLuint * ids);
GLEW_EXTERN_C GLboolean _glew_gles_glIsTransformFeedback (GLuint id);
GLEW_EXTERN_C void _glew_gles_glPauseTransformFeedback ();
GLEW_EXTERN_C void _glew_gles_glResumeTransformFeedback ();
GLEW_EXTERN_C void _glew_gles_glGetProgramBinary (GLuint program, GLsizei bufSize, GLsizei * length, GLenum * binaryFormat, void * binary);
GLEW_EXTERN_C void _glew_gles_glProgramBinary (GLuint program, GLenum binaryFormat, const void * binary, GLsizei length);
GLEW_EXTERN_C void _glew_gles_glProgramParameteri (GLuint program, GLenum pname, GLint value);
GLEW_EXTERN_C void _glew_gles_glInvalidateFramebuffer (GLenum target, GLsizei numAttachments, const GLenum * attachments);
GLEW_EXTERN_C void _glew_gles_glInvalidateSubFramebuffer (GLenum target, GLsizei numAttachments, const GLenum * attachments, GLint x, GLint y, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glTexStorage2D (GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glTexStorage3D (GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);
GLEW_EXTERN_C void _glew_gles_glGetInternalformativ (GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint * params);
GLEW_EXTERN_C void _glew_gles_glDispatchCompute (GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z);
GLEW_EXTERN_C void _glew_gles_glDispatchComputeIndirect (GLintptr indirect);
GLEW_EXTERN_C void _glew_gles_glDrawArraysIndirect (GLenum mode, const void * indirect);
GLEW_EXTERN_C void _glew_gles_glDrawElementsIndirect (GLenum mode, GLenum type, const void * indirect);
GLEW_EXTERN_C void _glew_gles_glFramebufferParameteri (GLenum target, GLenum pname, GLint param);
GLEW_EXTERN_C void _glew_gles_glGetFramebufferParameteriv (GLenum target, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetProgramInterfaceiv (GLuint program, GLenum programInterface, GLenum pname, GLint * params);
GLEW_EXTERN_C GLuint _glew_gles_glGetProgramResourceIndex (GLuint program, GLenum programInterface, const GLchar * name);
GLEW_EXTERN_C void _glew_gles_glGetProgramResourceName (GLuint program, GLenum programInterface, GLuint index, GLsizei bufSize, GLsizei * length, GLchar * name);
GLEW_EXTERN_C void _glew_gles_glGetProgramResourceiv (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum * props, GLsizei bufSize, GLsizei * length, GLint * params);
GLEW_EXTERN_C GLint _glew_gles_glGetProgramResourceLocation (GLuint program, GLenum programInterface, const GLchar * name);
GLEW_EXTERN_C void _glew_gles_glUseProgramStages (GLuint pipeline, GLbitfield stages, GLuint program);
GLEW_EXTERN_C void _glew_gles_glActiveShaderProgram (GLuint pipeline, GLuint program);
GLEW_EXTERN_C GLuint _glew_gles_glCreateShaderProgramv (GLenum type, GLsizei count, const GLchar *const* strings);
GLEW_EXTERN_C void _glew_gles_glBindProgramPipeline (GLuint pipeline);
GLEW_EXTERN_C void _glew_gles_glDeleteProgramPipelines (GLsizei n, const GLuint * pipelines);
GLEW_EXTERN_C void _glew_gles_glGenProgramPipelines (GLsizei n, GLuint * pipelines);
GLEW_EXTERN_C GLboolean _glew_gles_glIsProgramPipeline (GLuint pipeline);
GLEW_EXTERN_C void _glew_gles_glGetProgramPipelineiv (GLuint pipeline, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1i (GLuint program, GLint location, GLint v0);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2i (GLuint program, GLint location, GLint v0, GLint v1);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3i (GLuint program, GLint location, GLint v0, GLint v1, GLint v2);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4i (GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1ui (GLuint program, GLint location, GLuint v0);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2ui (GLuint program, GLint location, GLuint v0, GLuint v1);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3ui (GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4ui (GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1f (GLuint program, GLint location, GLfloat v0);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2f (GLuint program, GLint location, GLfloat v0, GLfloat v1);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3f (GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4f (GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1iv (GLuint program, GLint location, GLsizei count, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2iv (GLuint program, GLint location, GLsizei count, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3iv (GLuint program, GLint location, GLsizei count, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4iv (GLuint program, GLint location, GLsizei count, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1uiv (GLuint program, GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2uiv (GLuint program, GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3uiv (GLuint program, GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4uiv (GLuint program, GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1fv (GLuint program, GLint location, GLsizei count, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2fv (GLuint program, GLint location, GLsizei count, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3fv (GLuint program, GLint location, GLsizei count, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4fv (GLuint program, GLint location, GLsizei count, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix2fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix3fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix4fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix2x3fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix3x2fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix2x4fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix4x2fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix3x4fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix4x3fv (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glValidateProgramPipeline (GLuint pipeline);
GLEW_EXTERN_C void _glew_gles_glGetProgramPipelineInfoLog (GLuint pipeline, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
GLEW_EXTERN_C void _glew_gles_glBindImageTexture (GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLenum format);
GLEW_EXTERN_C void _glew_gles_glGetBooleani_v (GLenum target, GLuint index, GLboolean * data);
GLEW_EXTERN_C void _glew_gles_glMemoryBarrier (GLbitfield barriers);
GLEW_EXTERN_C void _glew_gles_glMemoryBarrierByRegion (GLbitfield barriers);
GLEW_EXTERN_C void _glew_gles_glTexStorage2DMultisample (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
GLEW_EXTERN_C void _glew_gles_glGetMultisamplefv (GLenum pname, GLuint index, GLfloat * val);
GLEW_EXTERN_C void _glew_gles_glSampleMaski (GLuint maskNumber, GLbitfield mask);
GLEW_EXTERN_C void _glew_gles_glGetTexLevelParameteriv (GLenum target, GLint level, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetTexLevelParameterfv (GLenum target, GLint level, GLenum pname, GLfloat * params);
GLEW_EXTERN_C void _glew_gles_glBindVertexBuffer (GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride);
GLEW_EXTERN_C void _glew_gles_glVertexAttribFormat (GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset);
GLEW_EXTERN_C void _glew_gles_glVertexAttribIFormat (GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
GLEW_EXTERN_C void _glew_gles_glVertexAttribBinding (GLuint attribindex, GLuint bindingindex);
GLEW_EXTERN_C void _glew_gles_glVertexBindingDivisor (GLuint bindingindex, GLuint divisor);
GLEW_EXTERN_C void _glew_gles_glGetPerfMonitorGroupsAMD (GLint * numGroups, GLsizei groupsSize, GLuint * groups);
GLEW_EXTERN_C void _glew_gles_glGetPerfMonitorCountersAMD (GLuint group, GLint * numCounters, GLint * maxActiveCounters, GLsizei counterSize, GLuint * counters);
GLEW_EXTERN_C void _glew_gles_glGetPerfMonitorGroupStringAMD (GLuint group, GLsizei bufSize, GLsizei * length, GLchar * groupString);
GLEW_EXTERN_C void _glew_gles_glGetPerfMonitorCounterStringAMD (GLuint group, GLuint counter, GLsizei bufSize, GLsizei * length, GLchar * counterString);
GLEW_EXTERN_C void _glew_gles_glGetPerfMonitorCounterInfoAMD (GLuint group, GLuint counter, GLenum pname, void * data);
GLEW_EXTERN_C void _glew_gles_glGenPerfMonitorsAMD (GLsizei n, GLuint * monitors);
GLEW_EXTERN_C void _glew_gles_glDeletePerfMonitorsAMD (GLsizei n, GLuint * monitors);
GLEW_EXTERN_C void _glew_gles_glSelectPerfMonitorCountersAMD (GLuint monitor, GLboolean enable, GLuint group, GLint numCounters, GLuint * counterList);
GLEW_EXTERN_C void _glew_gles_glBeginPerfMonitorAMD (GLuint monitor);
GLEW_EXTERN_C void _glew_gles_glEndPerfMonitorAMD (GLuint monitor);
GLEW_EXTERN_C void _glew_gles_glGetPerfMonitorCounterDataAMD (GLuint monitor, GLenum pname, GLsizei dataSize, GLuint * data, GLint * bytesWritten);
GLEW_EXTERN_C void _glew_gles_glBlitFramebufferANGLE (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
GLEW_EXTERN_C void _glew_gles_glRenderbufferStorageMultisampleANGLE (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glDrawArraysInstancedANGLE (GLenum mode, GLint first, GLsizei count, GLsizei primcount);
GLEW_EXTERN_C void _glew_gles_glDrawElementsInstancedANGLE (GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei primcount);
GLEW_EXTERN_C void _glew_gles_glVertexAttribDivisorANGLE (GLuint index, GLuint divisor);
GLEW_EXTERN_C void _glew_gles_glGetTranslatedShaderSourceANGLE (GLuint shader, GLsizei bufsize, GLsizei * length, GLchar * source);
GLEW_EXTERN_C void _glew_gles_glCopyTextureLevelsAPPLE (GLuint destinationTexture, GLuint sourceTexture, GLint sourceBaseLevel, GLsizei sourceLevelCount);
GLEW_EXTERN_C void _glew_gles_glRenderbufferStorageMultisampleAPPLE (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glResolveMultisampleFramebufferAPPLE ();
GLEW_EXTERN_C GLsync _glew_gles_glFenceSyncAPPLE (GLenum condition, GLbitfield flags);
GLEW_EXTERN_C GLboolean _glew_gles_glIsSyncAPPLE (GLsync sync);
GLEW_EXTERN_C void _glew_gles_glDeleteSyncAPPLE (GLsync sync);
GLEW_EXTERN_C GLenum _glew_gles_glClientWaitSyncAPPLE (GLsync sync, GLbitfield flags, GLuint64 timeout);
GLEW_EXTERN_C void _glew_gles_glWaitSyncAPPLE (GLsync sync, GLbitfield flags, GLuint64 timeout);
GLEW_EXTERN_C void _glew_gles_glGetInteger64vAPPLE (GLenum pname, GLint64 * params);
GLEW_EXTERN_C void _glew_gles_glGetSyncivAPPLE (GLsync sync, GLenum pname, GLsizei bufSize, GLsizei * length, GLint * values);
GLEW_EXTERN_C void _glew_gles_glDrawArraysInstancedBaseInstanceEXT (GLenum mode, GLint first, GLsizei count, GLsizei instancecount, GLuint baseinstance);
GLEW_EXTERN_C void _glew_gles_glDrawElementsInstancedBaseInstanceEXT (GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount, GLuint baseinstance);
GLEW_EXTERN_C void _glew_gles_glDrawElementsInstancedBaseVertexBaseInstanceEXT (GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance);
GLEW_EXTERN_C void _glew_gles_glBufferStorageEXT (GLenum target, GLsizeiptr size, const void * data, GLbitfield flags);
GLEW_EXTERN_C void _glew_gles_glCopyImageSubDataEXT (GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth);
GLEW_EXTERN_C void _glew_gles_glLabelObjectEXT (GLenum type, GLuint object, GLsizei length, const GLchar * label);
GLEW_EXTERN_C void _glew_gles_glGetObjectLabelEXT (GLenum type, GLuint object, GLsizei bufSize, GLsizei * length, GLchar * label);
GLEW_EXTERN_C void _glew_gles_glInsertEventMarkerEXT (GLsizei length, const GLchar * marker);
GLEW_EXTERN_C void _glew_gles_glPushGroupMarkerEXT (GLsizei length, const GLchar * marker);
GLEW_EXTERN_C void _glew_gles_glPopGroupMarkerEXT ();
GLEW_EXTERN_C void _glew_gles_glDiscardFramebufferEXT (GLenum target, GLsizei numAttachments, const GLenum * attachments);
GLEW_EXTERN_C void _glew_gles_glGenQueriesEXT (GLsizei n, GLuint * ids);
GLEW_EXTERN_C void _glew_gles_glDeleteQueriesEXT (GLsizei n, const GLuint * ids);
GLEW_EXTERN_C GLboolean _glew_gles_glIsQueryEXT (GLuint id);
GLEW_EXTERN_C void _glew_gles_glBeginQueryEXT (GLenum target, GLuint id);
GLEW_EXTERN_C void _glew_gles_glEndQueryEXT (GLenum target);
GLEW_EXTERN_C void _glew_gles_glQueryCounterEXT (GLuint id, GLenum target);
GLEW_EXTERN_C void _glew_gles_glGetQueryivEXT (GLenum target, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetQueryObjectivEXT (GLuint id, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetQueryObjectuivEXT (GLuint id, GLenum pname, GLuint * params);
GLEW_EXTERN_C void _glew_gles_glGetQueryObjecti64vEXT (GLuint id, GLenum pname, GLint64 * params);
GLEW_EXTERN_C void _glew_gles_glGetQueryObjectui64vEXT (GLuint id, GLenum pname, GLuint64 * params);
GLEW_EXTERN_C void _glew_gles_glDrawBuffersEXT (GLsizei n, const GLenum * bufs);
GLEW_EXTERN_C void _glew_gles_glEnableiEXT (GLenum target, GLuint index);
GLEW_EXTERN_C void _glew_gles_glDisableiEXT (GLenum target, GLuint index);
GLEW_EXTERN_C void _glew_gles_glBlendEquationiEXT (GLuint buf, GLenum mode);
GLEW_EXTERN_C void _glew_gles_glBlendEquationSeparateiEXT (GLuint buf, GLenum modeRGB, GLenum modeAlpha);
GLEW_EXTERN_C void _glew_gles_glBlendFunciEXT (GLuint buf, GLenum src, GLenum dst);
GLEW_EXTERN_C void _glew_gles_glBlendFuncSeparateiEXT (GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
GLEW_EXTERN_C void _glew_gles_glColorMaskiEXT (GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
GLEW_EXTERN_C GLboolean _glew_gles_glIsEnablediEXT (GLenum target, GLuint index);
GLEW_EXTERN_C void _glew_gles_glDrawElementsBaseVertexEXT (GLenum mode, GLsizei count, GLenum type, const void * indices, GLint basevertex);
GLEW_EXTERN_C void _glew_gles_glDrawRangeElementsBaseVertexEXT (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void * indices, GLint basevertex);
GLEW_EXTERN_C void _glew_gles_glDrawElementsInstancedBaseVertexEXT (GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount, GLint basevertex);
GLEW_EXTERN_C void _glew_gles_glMultiDrawElementsBaseVertexEXT (GLenum mode, const GLsizei * count, GLenum type, const void *const* indices, GLsizei primcount, const GLint * basevertex);
GLEW_EXTERN_C void _glew_gles_glDrawArraysInstancedEXT (GLenum mode, GLint start, GLsizei count, GLsizei primcount);
GLEW_EXTERN_C void _glew_gles_glDrawElementsInstancedEXT (GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei primcount);
GLEW_EXTERN_C void _glew_gles_glFramebufferTextureEXT (GLenum target, GLenum attachment, GLuint texture, GLint level);
GLEW_EXTERN_C void _glew_gles_glVertexAttribDivisorEXT (GLuint index, GLuint divisor);
GLEW_EXTERN_C void * _glew_gles_glMapBufferRangeEXT (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
GLEW_EXTERN_C void _glew_gles_glFlushMappedBufferRangeEXT (GLenum target, GLintptr offset, GLsizeiptr length);
GLEW_EXTERN_C void _glew_gles_glMultiDrawArraysEXT (GLenum mode, const GLint * first, const GLsizei * count, GLsizei primcount);
GLEW_EXTERN_C void _glew_gles_glMultiDrawElementsEXT (GLenum mode, const GLsizei * count, GLenum type, const void *const* indices, GLsizei primcount);
GLEW_EXTERN_C void _glew_gles_glMultiDrawArraysIndirectEXT (GLenum mode, const void * indirect, GLsizei drawcount, GLsizei stride);
GLEW_EXTERN_C void _glew_gles_glMultiDrawElementsIndirectEXT (GLenum mode, GLenum type, const void * indirect, GLsizei drawcount, GLsizei stride);
GLEW_EXTERN_C void _glew_gles_glRenderbufferStorageMultisampleEXT (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glFramebufferTexture2DMultisampleEXT (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLsizei samples);
GLEW_EXTERN_C void _glew_gles_glReadBufferIndexedEXT (GLenum src, GLint index);
GLEW_EXTERN_C void _glew_gles_glDrawBuffersIndexedEXT (GLint n, const GLenum * location, const GLint * indices);
GLEW_EXTERN_C void _glew_gles_glGetIntegeri_vEXT (GLenum target, GLuint index, GLint * data);
GLEW_EXTERN_C void _glew_gles_glPrimitiveBoundingBoxEXT (GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW);
GLEW_EXTERN_C void _glew_gles_glRasterSamplesEXT (GLuint samples, GLboolean fixedsamplelocations);
GLEW_EXTERN_C GLenum _glew_gles_glGetGraphicsResetStatusEXT ();
GLEW_EXTERN_C void _glew_gles_glReadnPixelsEXT (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, void * data);
GLEW_EXTERN_C void _glew_gles_glGetnUniformfvEXT (GLuint program, GLint location, GLsizei bufSize, GLfloat * params);
GLEW_EXTERN_C void _glew_gles_glGetnUniformivEXT (GLuint program, GLint location, GLsizei bufSize, GLint * params);
GLEW_EXTERN_C void _glew_gles_glActiveShaderProgramEXT (GLuint pipeline, GLuint program);
GLEW_EXTERN_C void _glew_gles_glBindProgramPipelineEXT (GLuint pipeline);
GLEW_EXTERN_C GLuint _glew_gles_glCreateShaderProgramvEXT (GLenum type, GLsizei count, const GLchar ** strings);
GLEW_EXTERN_C void _glew_gles_glDeleteProgramPipelinesEXT (GLsizei n, const GLuint * pipelines);
GLEW_EXTERN_C void _glew_gles_glGenProgramPipelinesEXT (GLsizei n, GLuint * pipelines);
GLEW_EXTERN_C void _glew_gles_glGetProgramPipelineInfoLogEXT (GLuint pipeline, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
GLEW_EXTERN_C void _glew_gles_glGetProgramPipelineivEXT (GLuint pipeline, GLenum pname, GLint * params);
GLEW_EXTERN_C GLboolean _glew_gles_glIsProgramPipelineEXT (GLuint pipeline);
GLEW_EXTERN_C void _glew_gles_glProgramParameteriEXT (GLuint program, GLenum pname, GLint value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1fEXT (GLuint program, GLint location, GLfloat v0);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1fvEXT (GLuint program, GLint location, GLsizei count, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1iEXT (GLuint program, GLint location, GLint v0);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1ivEXT (GLuint program, GLint location, GLsizei count, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2fEXT (GLuint program, GLint location, GLfloat v0, GLfloat v1);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2fvEXT (GLuint program, GLint location, GLsizei count, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2iEXT (GLuint program, GLint location, GLint v0, GLint v1);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2ivEXT (GLuint program, GLint location, GLsizei count, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3fEXT (GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3fvEXT (GLuint program, GLint location, GLsizei count, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3iEXT (GLuint program, GLint location, GLint v0, GLint v1, GLint v2);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3ivEXT (GLuint program, GLint location, GLsizei count, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4fEXT (GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4fvEXT (GLuint program, GLint location, GLsizei count, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4iEXT (GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4ivEXT (GLuint program, GLint location, GLsizei count, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix2fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix3fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix4fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUseProgramStagesEXT (GLuint pipeline, GLbitfield stages, GLuint program);
GLEW_EXTERN_C void _glew_gles_glValidateProgramPipelineEXT (GLuint pipeline);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1uiEXT (GLuint program, GLint location, GLuint v0);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2uiEXT (GLuint program, GLint location, GLuint v0, GLuint v1);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3uiEXT (GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4uiEXT (GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
GLEW_EXTERN_C void _glew_gles_glProgramUniform1uivEXT (GLuint program, GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform2uivEXT (GLuint program, GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform3uivEXT (GLuint program, GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniform4uivEXT (GLuint program, GLint location, GLsizei count, const GLuint * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix2x3fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix3x2fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix2x4fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix4x2fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix3x4fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformMatrix4x3fvEXT (GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glTexPageCommitmentARB (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean commit);
GLEW_EXTERN_C void _glew_gles_glPatchParameteriEXT (GLenum pname, GLint value);
GLEW_EXTERN_C void _glew_gles_glTexParameterIivEXT (GLenum target, GLenum pname, const GLint * params);
GLEW_EXTERN_C void _glew_gles_glTexParameterIuivEXT (GLenum target, GLenum pname, const GLuint * params);
GLEW_EXTERN_C void _glew_gles_glGetTexParameterIivEXT (GLenum target, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetTexParameterIuivEXT (GLenum target, GLenum pname, GLuint * params);
GLEW_EXTERN_C void _glew_gles_glSamplerParameterIivEXT (GLuint sampler, GLenum pname, const GLint * param);
GLEW_EXTERN_C void _glew_gles_glSamplerParameterIuivEXT (GLuint sampler, GLenum pname, const GLuint * param);
GLEW_EXTERN_C void _glew_gles_glGetSamplerParameterIivEXT (GLuint sampler, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetSamplerParameterIuivEXT (GLuint sampler, GLenum pname, GLuint * params);
GLEW_EXTERN_C void _glew_gles_glTexBufferEXT (GLenum target, GLenum internalformat, GLuint buffer);
GLEW_EXTERN_C void _glew_gles_glTexBufferRangeEXT (GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
GLEW_EXTERN_C void _glew_gles_glTexStorage1DEXT (GLenum target, GLsizei levels, GLenum internalformat, GLsizei width);
GLEW_EXTERN_C void _glew_gles_glTexStorage2DEXT (GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glTexStorage3DEXT (GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);
GLEW_EXTERN_C void _glew_gles_glTextureStorage1DEXT (GLuint texture, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width);
GLEW_EXTERN_C void _glew_gles_glTextureStorage2DEXT (GLuint texture, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glTextureStorage3DEXT (GLuint texture, GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);
GLEW_EXTERN_C void _glew_gles_glTextureViewEXT (GLuint texture, GLenum target, GLuint origtexture, GLenum internalformat, GLuint minlevel, GLuint numlevels, GLuint minlayer, GLuint numlayers);
GLEW_EXTERN_C void _glew_gles_glRenderbufferStorageMultisampleIMG (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glFramebufferTexture2DMultisampleIMG (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLsizei samples);
GLEW_EXTERN_C void _glew_gles_glBeginPerfQueryINTEL (GLuint queryHandle);
GLEW_EXTERN_C void _glew_gles_glCreatePerfQueryINTEL (GLuint queryId, GLuint * queryHandle);
GLEW_EXTERN_C void _glew_gles_glDeletePerfQueryINTEL (GLuint queryHandle);
GLEW_EXTERN_C void _glew_gles_glEndPerfQueryINTEL (GLuint queryHandle);
GLEW_EXTERN_C void _glew_gles_glGetFirstPerfQueryIdINTEL (GLuint * queryId);
GLEW_EXTERN_C void _glew_gles_glGetNextPerfQueryIdINTEL (GLuint queryId, GLuint * nextQueryId);
GLEW_EXTERN_C void _glew_gles_glGetPerfCounterInfoINTEL (GLuint queryId, GLuint counterId, GLuint counterNameLength, GLchar * counterName, GLuint counterDescLength, GLchar * counterDesc, GLuint * counterOffset, GLuint * counterDataSize, GLuint * counterTypeEnum, GLuint * counterDataTypeEnum, GLuint64 * rawCounterMaxValue);
GLEW_EXTERN_C void _glew_gles_glGetPerfQueryDataINTEL (GLuint queryHandle, GLuint flags, GLsizei dataSize, GLvoid * data, GLuint * bytesWritten);
GLEW_EXTERN_C void _glew_gles_glGetPerfQueryIdByNameINTEL (GLchar * queryName, GLuint * queryId);
GLEW_EXTERN_C void _glew_gles_glGetPerfQueryInfoINTEL (GLuint queryId, GLuint queryNameLength, GLchar * queryName, GLuint * dataSize, GLuint * noCounters, GLuint * noInstances, GLuint * capsMask);
GLEW_EXTERN_C void _glew_gles_glBlendBarrierKHR ();
GLEW_EXTERN_C void _glew_gles_glDebugMessageControlKHR (GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint * ids, GLboolean enabled);
GLEW_EXTERN_C void _glew_gles_glDebugMessageInsertKHR (GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar * buf);
GLEW_EXTERN_C void _glew_gles_glDebugMessageCallbackKHR (GLDEBUGPROCKHR callback, const void * userParam);
GLEW_EXTERN_C GLuint _glew_gles_glGetDebugMessageLogKHR (GLuint count, GLsizei bufSize, GLenum * sources, GLenum * types, GLuint * ids, GLenum * severities, GLsizei * lengths, GLchar * messageLog);
GLEW_EXTERN_C void _glew_gles_glPushDebugGroupKHR (GLenum source, GLuint id, GLsizei length, const GLchar * message);
GLEW_EXTERN_C void _glew_gles_glPopDebugGroupKHR ();
GLEW_EXTERN_C void _glew_gles_glObjectLabelKHR (GLenum identifier, GLuint name, GLsizei length, const GLchar * label);
GLEW_EXTERN_C void _glew_gles_glGetObjectLabelKHR (GLenum identifier, GLuint name, GLsizei bufSize, GLsizei * length, GLchar * label);
GLEW_EXTERN_C void _glew_gles_glObjectPtrLabelKHR (const void * ptr, GLsizei length, const GLchar * label);
GLEW_EXTERN_C void _glew_gles_glGetObjectPtrLabelKHR (const void * ptr, GLsizei bufSize, GLsizei * length, GLchar * label);
GLEW_EXTERN_C void _glew_gles_glGetPointervKHR (GLenum pname, void ** params);
GLEW_EXTERN_C GLenum _glew_gles_glGetGraphicsResetStatusKHR ();
GLEW_EXTERN_C void _glew_gles_glReadnPixelsKHR (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, void * data);
GLEW_EXTERN_C void _glew_gles_glGetnUniformfvKHR (GLuint program, GLint location, GLsizei bufSize, GLfloat * params);
GLEW_EXTERN_C void _glew_gles_glGetnUniformivKHR (GLuint program, GLint location, GLsizei bufSize, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetnUniformuivKHR (GLuint program, GLint location, GLsizei bufSize, GLuint * params);
GLEW_EXTERN_C GLuint64 _glew_gles_glGetTextureHandleNV (GLuint texture);
GLEW_EXTERN_C GLuint64 _glew_gles_glGetTextureSamplerHandleNV (GLuint texture, GLuint sampler);
GLEW_EXTERN_C void _glew_gles_glMakeTextureHandleResidentNV (GLuint64 handle);
GLEW_EXTERN_C void _glew_gles_glMakeTextureHandleNonResidentNV (GLuint64 handle);
GLEW_EXTERN_C GLuint64 _glew_gles_glGetImageHandleNV (GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum format);
GLEW_EXTERN_C void _glew_gles_glMakeImageHandleResidentNV (GLuint64 handle, GLenum access);
GLEW_EXTERN_C void _glew_gles_glMakeImageHandleNonResidentNV (GLuint64 handle);
GLEW_EXTERN_C void _glew_gles_glUniformHandleui64NV (GLint location, GLuint64 value);
GLEW_EXTERN_C void _glew_gles_glUniformHandleui64vNV (GLint location, GLsizei count, const GLuint64 * value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformHandleui64NV (GLuint program, GLint location, GLuint64 value);
GLEW_EXTERN_C void _glew_gles_glProgramUniformHandleui64vNV (GLuint program, GLint location, GLsizei count, const GLuint64 * values);
GLEW_EXTERN_C GLboolean _glew_gles_glIsTextureHandleResidentNV (GLuint64 handle);
GLEW_EXTERN_C GLboolean _glew_gles_glIsImageHandleResidentNV (GLuint64 handle);
GLEW_EXTERN_C void _glew_gles_glBlendParameteriNV (GLenum pname, GLint value);
GLEW_EXTERN_C void _glew_gles_glBlendBarrierNV ();
GLEW_EXTERN_C void _glew_gles_glBeginConditionalRenderNV (GLuint id, GLenum mode);
GLEW_EXTERN_C void _glew_gles_glEndConditionalRenderNV ();
GLEW_EXTERN_C void _glew_gles_glSubpixelPrecisionBiasNV (GLuint xbits, GLuint ybits);
GLEW_EXTERN_C void _glew_gles_glCopyBufferSubDataNV (GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
GLEW_EXTERN_C void _glew_gles_glCoverageMaskNV (GLboolean mask);
GLEW_EXTERN_C void _glew_gles_glCoverageOperationNV (GLenum operation);
GLEW_EXTERN_C void _glew_gles_glDrawBuffersNV (GLsizei n, const GLenum * bufs);
GLEW_EXTERN_C void _glew_gles_glDrawArraysInstancedNV (GLenum mode, GLint first, GLsizei count, GLsizei primcount);
GLEW_EXTERN_C void _glew_gles_glDrawElementsInstancedNV (GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei primcount);
GLEW_EXTERN_C void _glew_gles_glDeleteFencesNV (GLsizei n, const GLuint * fences);
GLEW_EXTERN_C void _glew_gles_glGenFencesNV (GLsizei n, GLuint * fences);
GLEW_EXTERN_C GLboolean _glew_gles_glIsFenceNV (GLuint fence);
GLEW_EXTERN_C GLboolean _glew_gles_glTestFenceNV (GLuint fence);
GLEW_EXTERN_C void _glew_gles_glGetFenceivNV (GLuint fence, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glFinishFenceNV (GLuint fence);
GLEW_EXTERN_C void _glew_gles_glSetFenceNV (GLuint fence, GLenum condition);
GLEW_EXTERN_C void _glew_gles_glFragmentCoverageColorNV (GLuint color);
GLEW_EXTERN_C void _glew_gles_glBlitFramebufferNV (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
GLEW_EXTERN_C void _glew_gles_glCoverageModulationTableNV (GLsizei n, const GLfloat * v);
GLEW_EXTERN_C void _glew_gles_glGetCoverageModulationTableNV (GLsizei bufsize, GLfloat * v);
GLEW_EXTERN_C void _glew_gles_glCoverageModulationNV (GLenum components);
GLEW_EXTERN_C void _glew_gles_glRenderbufferStorageMultisampleNV (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glVertexAttribDivisorNV (GLuint index, GLuint divisor);
GLEW_EXTERN_C void _glew_gles_glGetInternalformatSampleivNV (GLenum target, GLenum internalformat, GLsizei samples, GLenum pname, GLsizei bufSize, GLint * params);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix2x3fvNV (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix3x2fvNV (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix2x4fvNV (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix4x2fvNV (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix3x4fvNV (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glUniformMatrix4x3fvNV (GLint location, GLsizei count, GLboolean transpose, const GLfloat * value);
GLEW_EXTERN_C GLuint _glew_gles_glGenPathsNV (GLsizei range);
GLEW_EXTERN_C void _glew_gles_glDeletePathsNV (GLuint path, GLsizei range);
GLEW_EXTERN_C GLboolean _glew_gles_glIsPathNV (GLuint path);
GLEW_EXTERN_C void _glew_gles_glPathCommandsNV (GLuint path, GLsizei numCommands, const GLubyte * commands, GLsizei numCoords, GLenum coordType, const void * coords);
GLEW_EXTERN_C void _glew_gles_glPathCoordsNV (GLuint path, GLsizei numCoords, GLenum coordType, const void * coords);
GLEW_EXTERN_C void _glew_gles_glPathSubCommandsNV (GLuint path, GLsizei commandStart, GLsizei commandsToDelete, GLsizei numCommands, const GLubyte * commands, GLsizei numCoords, GLenum coordType, const void * coords);
GLEW_EXTERN_C void _glew_gles_glPathSubCoordsNV (GLuint path, GLsizei coordStart, GLsizei numCoords, GLenum coordType, const void * coords);
GLEW_EXTERN_C void _glew_gles_glPathStringNV (GLuint path, GLenum format, GLsizei length, const void * pathString);
GLEW_EXTERN_C void _glew_gles_glPathGlyphsNV (GLuint firstPathName, GLenum fontTarget, const void * fontName, GLbitfield fontStyle, GLsizei numGlyphs, GLenum type, const void * charcodes, GLenum handleMissingGlyphs, GLuint pathParameterTemplate, GLfloat emScale);
GLEW_EXTERN_C void _glew_gles_glPathGlyphRangeNV (GLuint firstPathName, GLenum fontTarget, const void * fontName, GLbitfield fontStyle, GLuint firstGlyph, GLsizei numGlyphs, GLenum handleMissingGlyphs, GLuint pathParameterTemplate, GLfloat emScale);
GLEW_EXTERN_C void _glew_gles_glWeightPathsNV (GLuint resultPath, GLsizei numPaths, const GLuint * paths, const GLfloat * weights);
GLEW_EXTERN_C void _glew_gles_glCopyPathNV (GLuint resultPath, GLuint srcPath);
GLEW_EXTERN_C void _glew_gles_glInterpolatePathsNV (GLuint resultPath, GLuint pathA, GLuint pathB, GLfloat weight);
GLEW_EXTERN_C void _glew_gles_glTransformPathNV (GLuint resultPath, GLuint srcPath, GLenum transformType, const GLfloat * transformValues);
GLEW_EXTERN_C void _glew_gles_glPathParameterivNV (GLuint path, GLenum pname, const GLint * value);
GLEW_EXTERN_C void _glew_gles_glPathParameteriNV (GLuint path, GLenum pname, GLint value);
GLEW_EXTERN_C void _glew_gles_glPathParameterfvNV (GLuint path, GLenum pname, const GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glPathParameterfNV (GLuint path, GLenum pname, GLfloat value);
GLEW_EXTERN_C void _glew_gles_glPathDashArrayNV (GLuint path, GLsizei dashCount, const GLfloat * dashArray);
GLEW_EXTERN_C void _glew_gles_glPathStencilFuncNV (GLenum func, GLint ref, GLuint mask);
GLEW_EXTERN_C void _glew_gles_glPathStencilDepthOffsetNV (GLfloat factor, GLfloat units);
GLEW_EXTERN_C void _glew_gles_glStencilFillPathNV (GLuint path, GLenum fillMode, GLuint mask);
GLEW_EXTERN_C void _glew_gles_glStencilStrokePathNV (GLuint path, GLint reference, GLuint mask);
GLEW_EXTERN_C void _glew_gles_glStencilFillPathInstancedNV (GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum transformType, const GLfloat * transformValues);
GLEW_EXTERN_C void _glew_gles_glStencilStrokePathInstancedNV (GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLint reference, GLuint mask, GLenum transformType, const GLfloat * transformValues);
GLEW_EXTERN_C void _glew_gles_glPathCoverDepthFuncNV (GLenum func);
GLEW_EXTERN_C void _glew_gles_glCoverFillPathNV (GLuint path, GLenum coverMode);
GLEW_EXTERN_C void _glew_gles_glCoverStrokePathNV (GLuint path, GLenum coverMode);
GLEW_EXTERN_C void _glew_gles_glCoverFillPathInstancedNV (GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat * transformValues);
GLEW_EXTERN_C void _glew_gles_glCoverStrokePathInstancedNV (GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat * transformValues);
GLEW_EXTERN_C void _glew_gles_glGetPathParameterivNV (GLuint path, GLenum pname, GLint * value);
GLEW_EXTERN_C void _glew_gles_glGetPathParameterfvNV (GLuint path, GLenum pname, GLfloat * value);
GLEW_EXTERN_C void _glew_gles_glGetPathCommandsNV (GLuint path, GLubyte * commands);
GLEW_EXTERN_C void _glew_gles_glGetPathCoordsNV (GLuint path, GLfloat * coords);
GLEW_EXTERN_C void _glew_gles_glGetPathDashArrayNV (GLuint path, GLfloat * dashArray);
GLEW_EXTERN_C void _glew_gles_glGetPathMetricsNV (GLbitfield metricQueryMask, GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLsizei stride, GLfloat * metrics);
GLEW_EXTERN_C void _glew_gles_glGetPathMetricRangeNV (GLbitfield metricQueryMask, GLuint firstPathName, GLsizei numPaths, GLsizei stride, GLfloat * metrics);
GLEW_EXTERN_C void _glew_gles_glGetPathSpacingNV (GLenum pathListMode, GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLfloat advanceScale, GLfloat kerningScale, GLenum transformType, GLfloat * returnedSpacing);
GLEW_EXTERN_C GLboolean _glew_gles_glIsPointInFillPathNV (GLuint path, GLuint mask, GLfloat x, GLfloat y);
GLEW_EXTERN_C GLboolean _glew_gles_glIsPointInStrokePathNV (GLuint path, GLfloat x, GLfloat y);
GLEW_EXTERN_C GLfloat _glew_gles_glGetPathLengthNV (GLuint path, GLsizei startSegment, GLsizei numSegments);
GLEW_EXTERN_C GLboolean _glew_gles_glPointAlongPathNV (GLuint path, GLsizei startSegment, GLsizei numSegments, GLfloat distance, GLfloat * x, GLfloat * y, GLfloat * tangentX, GLfloat * tangentY);
GLEW_EXTERN_C void _glew_gles_glMatrixLoad3x2fNV (GLenum matrixMode, const GLfloat * m);
GLEW_EXTERN_C void _glew_gles_glMatrixLoad3x3fNV (GLenum matrixMode, const GLfloat * m);
GLEW_EXTERN_C void _glew_gles_glMatrixLoadTranspose3x3fNV (GLenum matrixMode, const GLfloat * m);
GLEW_EXTERN_C void _glew_gles_glMatrixMult3x2fNV (GLenum matrixMode, const GLfloat * m);
GLEW_EXTERN_C void _glew_gles_glMatrixMult3x3fNV (GLenum matrixMode, const GLfloat * m);
GLEW_EXTERN_C void _glew_gles_glMatrixMultTranspose3x3fNV (GLenum matrixMode, const GLfloat * m);
GLEW_EXTERN_C void _glew_gles_glStencilThenCoverFillPathNV (GLuint path, GLenum fillMode, GLuint mask, GLenum coverMode);
GLEW_EXTERN_C void _glew_gles_glStencilThenCoverStrokePathNV (GLuint path, GLint reference, GLuint mask, GLenum coverMode);
GLEW_EXTERN_C void _glew_gles_glStencilThenCoverFillPathInstancedNV (GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat * transformValues);
GLEW_EXTERN_C void _glew_gles_glStencilThenCoverStrokePathInstancedNV (GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLint reference, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat * transformValues);
GLEW_EXTERN_C GLenum _glew_gles_glPathGlyphIndexRangeNV (GLenum fontTarget, const void * fontName, GLbitfield fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint baseAndCount[2]);
GLEW_EXTERN_C GLenum _glew_gles_glPathGlyphIndexArrayNV (GLuint firstPathName, GLenum fontTarget, const void * fontName, GLbitfield fontStyle, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale);
GLEW_EXTERN_C GLenum _glew_gles_glPathMemoryGlyphIndexArrayNV (GLuint firstPathName, GLenum fontTarget, GLsizeiptr fontSize, const void * fontData, GLsizei faceIndex, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale);
GLEW_EXTERN_C void _glew_gles_glProgramPathFragmentInputGenNV (GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat * coeffs);
GLEW_EXTERN_C void _glew_gles_glGetProgramResourcefvNV (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum * props, GLsizei bufSize, GLsizei * length, GLfloat * params);
GLEW_EXTERN_C void _glew_gles_glPolygonModeNV (GLenum face, GLenum mode);
GLEW_EXTERN_C void _glew_gles_glReadBufferNV (GLenum mode);
GLEW_EXTERN_C void _glew_gles_glFramebufferSampleLocationsfvNV (GLenum target, GLuint start, GLsizei count, const GLfloat * v);
GLEW_EXTERN_C void _glew_gles_glNamedFramebufferSampleLocationsfvNV (GLuint framebuffer, GLuint start, GLsizei count, const GLfloat * v);
GLEW_EXTERN_C void _glew_gles_glResolveDepthValuesNV ();
GLEW_EXTERN_C void _glew_gles_glViewportArrayvNV (GLuint first, GLsizei count, const GLfloat * v);
GLEW_EXTERN_C void _glew_gles_glViewportIndexedfNV (GLuint index, GLfloat x, GLfloat y, GLfloat w, GLfloat h);
GLEW_EXTERN_C void _glew_gles_glViewportIndexedfvNV (GLuint index, const GLfloat * v);
GLEW_EXTERN_C void _glew_gles_glScissorArrayvNV (GLuint first, GLsizei count, const GLint * v);
GLEW_EXTERN_C void _glew_gles_glScissorIndexedNV (GLuint index, GLint left, GLint bottom, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glScissorIndexedvNV (GLuint index, const GLint * v);
GLEW_EXTERN_C void _glew_gles_glDepthRangeArrayfvNV (GLuint first, GLsizei count, const GLfloat * v);
GLEW_EXTERN_C void _glew_gles_glDepthRangeIndexedfNV (GLuint index, GLfloat n, GLfloat f);
GLEW_EXTERN_C void _glew_gles_glGetFloati_vNV (GLenum target, GLuint index, GLfloat * data);
GLEW_EXTERN_C void _glew_gles_glEnableiNV (GLenum target, GLuint index);
GLEW_EXTERN_C void _glew_gles_glDisableiNV (GLenum target, GLuint index);
GLEW_EXTERN_C GLboolean _glew_gles_glIsEnablediNV (GLenum target, GLuint index);
GLEW_EXTERN_C void _glew_gles_glEGLImageTargetTexture2DOES (GLenum target, GLeglImageOES image);
GLEW_EXTERN_C void _glew_gles_glEGLImageTargetRenderbufferStorageOES (GLenum target, GLeglImageOES image);
GLEW_EXTERN_C void _glew_gles_glCopyImageSubDataOES (GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth);
GLEW_EXTERN_C void _glew_gles_glEnableiOES (GLenum target, GLuint index);
GLEW_EXTERN_C void _glew_gles_glDisableiOES (GLenum target, GLuint index);
GLEW_EXTERN_C void _glew_gles_glBlendEquationiOES (GLuint buf, GLenum mode);
GLEW_EXTERN_C void _glew_gles_glBlendEquationSeparateiOES (GLuint buf, GLenum modeRGB, GLenum modeAlpha);
GLEW_EXTERN_C void _glew_gles_glBlendFunciOES (GLuint buf, GLenum src, GLenum dst);
GLEW_EXTERN_C void _glew_gles_glBlendFuncSeparateiOES (GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
GLEW_EXTERN_C void _glew_gles_glColorMaskiOES (GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a);
GLEW_EXTERN_C GLboolean _glew_gles_glIsEnablediOES (GLenum target, GLuint index);
GLEW_EXTERN_C void _glew_gles_glDrawElementsBaseVertexOES (GLenum mode, GLsizei count, GLenum type, const void * indices, GLint basevertex);
GLEW_EXTERN_C void _glew_gles_glDrawRangeElementsBaseVertexOES (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void * indices, GLint basevertex);
GLEW_EXTERN_C void _glew_gles_glDrawElementsInstancedBaseVertexOES (GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei instancecount, GLint basevertex);
GLEW_EXTERN_C void _glew_gles_glMultiDrawElementsBaseVertexOES (GLenum mode, const GLsizei * count, GLenum type, const void *const* indices, GLsizei primcount, const GLint * basevertex);
GLEW_EXTERN_C void _glew_gles_glFramebufferTextureOES (GLenum target, GLenum attachment, GLuint texture, GLint level);
GLEW_EXTERN_C void _glew_gles_glGetProgramBinaryOES (GLuint program, GLsizei bufSize, GLsizei * length, GLenum * binaryFormat, void * binary);
GLEW_EXTERN_C void _glew_gles_glProgramBinaryOES (GLuint program, GLenum binaryFormat, const void * binary, GLint length);
GLEW_EXTERN_C void * _glew_gles_glMapBufferOES (GLenum target, GLenum access);
GLEW_EXTERN_C GLboolean _glew_gles_glUnmapBufferOES (GLenum target);
GLEW_EXTERN_C void _glew_gles_glGetBufferPointervOES (GLenum target, GLenum pname, void ** params);
GLEW_EXTERN_C void _glew_gles_glPrimitiveBoundingBoxOES (GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW);
GLEW_EXTERN_C void _glew_gles_glMinSampleShadingOES (GLfloat value);
GLEW_EXTERN_C void _glew_gles_glPatchParameteriOES (GLenum pname, GLint value);
GLEW_EXTERN_C void _glew_gles_glTexImage3DOES (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void * pixels);
GLEW_EXTERN_C void _glew_gles_glTexSubImage3DOES (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void * pixels);
GLEW_EXTERN_C void _glew_gles_glCopyTexSubImage3DOES (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
GLEW_EXTERN_C void _glew_gles_glCompressedTexImage3DOES (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void * data);
GLEW_EXTERN_C void _glew_gles_glCompressedTexSubImage3DOES (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void * data);
GLEW_EXTERN_C void _glew_gles_glFramebufferTexture3DOES (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset);
GLEW_EXTERN_C void _glew_gles_glTexParameterIivOES (GLenum target, GLenum pname, const GLint * params);
GLEW_EXTERN_C void _glew_gles_glTexParameterIuivOES (GLenum target, GLenum pname, const GLuint * params);
GLEW_EXTERN_C void _glew_gles_glGetTexParameterIivOES (GLenum target, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetTexParameterIuivOES (GLenum target, GLenum pname, GLuint * params);
GLEW_EXTERN_C void _glew_gles_glSamplerParameterIivOES (GLuint sampler, GLenum pname, const GLint * param);
GLEW_EXTERN_C void _glew_gles_glSamplerParameterIuivOES (GLuint sampler, GLenum pname, const GLuint * param);
GLEW_EXTERN_C void _glew_gles_glGetSamplerParameterIivOES (GLuint sampler, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glGetSamplerParameterIuivOES (GLuint sampler, GLenum pname, GLuint * params);
GLEW_EXTERN_C void _glew_gles_glTexBufferOES (GLenum target, GLenum internalformat, GLuint buffer);
GLEW_EXTERN_C void _glew_gles_glTexBufferRangeOES (GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
GLEW_EXTERN_C void _glew_gles_glTexStorage3DMultisampleOES (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
GLEW_EXTERN_C void _glew_gles_glTextureViewOES (GLuint texture, GLenum target, GLuint origtexture, GLenum internalformat, GLuint minlevel, GLuint numlevels, GLuint minlayer, GLuint numlayers);
GLEW_EXTERN_C void _glew_gles_glBindVertexArrayOES (GLuint array);
GLEW_EXTERN_C void _glew_gles_glDeleteVertexArraysOES (GLsizei n, const GLuint * arrays);
GLEW_EXTERN_C void _glew_gles_glGenVertexArraysOES (GLsizei n, GLuint * arrays);
GLEW_EXTERN_C GLboolean _glew_gles_glIsVertexArrayOES (GLuint array);
GLEW_EXTERN_C void _glew_gles_glFramebufferTextureMultiviewOVR (GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews);
GLEW_EXTERN_C void _glew_gles_glAlphaFuncQCOM (GLenum func, GLclampf ref);
GLEW_EXTERN_C void _glew_gles_glGetDriverControlsQCOM (GLint * num, GLsizei size, GLuint * driverControls);
GLEW_EXTERN_C void _glew_gles_glGetDriverControlStringQCOM (GLuint driverControl, GLsizei bufSize, GLsizei * length, GLchar * driverControlString);
GLEW_EXTERN_C void _glew_gles_glEnableDriverControlQCOM (GLuint driverControl);
GLEW_EXTERN_C void _glew_gles_glDisableDriverControlQCOM (GLuint driverControl);
GLEW_EXTERN_C void _glew_gles_glExtGetTexturesQCOM (GLuint * textures, GLint maxTextures, GLint * numTextures);
GLEW_EXTERN_C void _glew_gles_glExtGetBuffersQCOM (GLuint * buffers, GLint maxBuffers, GLint * numBuffers);
GLEW_EXTERN_C void _glew_gles_glExtGetRenderbuffersQCOM (GLuint * renderbuffers, GLint maxRenderbuffers, GLint * numRenderbuffers);
GLEW_EXTERN_C void _glew_gles_glExtGetFramebuffersQCOM (GLuint * framebuffers, GLint maxFramebuffers, GLint * numFramebuffers);
GLEW_EXTERN_C void _glew_gles_glExtGetTexLevelParameterivQCOM (GLuint texture, GLenum face, GLint level, GLenum pname, GLint * params);
GLEW_EXTERN_C void _glew_gles_glExtTexObjectStateOverrideiQCOM (GLenum target, GLenum pname, GLint param);
GLEW_EXTERN_C void _glew_gles_glExtGetTexSubImageQCOM (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, void * texels);
GLEW_EXTERN_C void _glew_gles_glExtGetBufferPointervQCOM (GLenum target, void ** params);
GLEW_EXTERN_C void _glew_gles_glExtGetShadersQCOM (GLuint * shaders, GLint maxShaders, GLint * numShaders);
GLEW_EXTERN_C void _glew_gles_glExtGetProgramsQCOM (GLuint * programs, GLint maxPrograms, GLint * numPrograms);
GLEW_EXTERN_C GLboolean _glew_gles_glExtIsProgramBinaryQCOM (GLuint program);
GLEW_EXTERN_C void _glew_gles_glExtGetProgramBinarySourceQCOM (GLuint program, GLenum shadertype, GLchar * source, GLint * length);
GLEW_EXTERN_C void _glew_gles_glStartTilingQCOM (GLuint x, GLuint y, GLuint width, GLuint height, GLbitfield preserveMask);
GLEW_EXTERN_C void _glew_gles_glEndTilingQCOM (GLbitfield preserveMask);
...
#define glTexPageCommitmentARB _glew_gles_glTexPageCommitmentARB
...
#define glMultiDrawElementsBaseVertexOES _glew_gles_glMultiDrawElementsBaseVertexOES
