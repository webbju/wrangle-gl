...
GLXBoolean glxwQueryCapabilities (GLXCapabilities *capabilities);

const GLXCapabilities *glxwGetCapabilities ();

GLXBoolean glxwSetCapabilities (const GLXCapabilities *capabilities);
