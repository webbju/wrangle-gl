...
namespace glew
{
  ...
  public:
    ...
    static bool IsSupported (GLEW_GLX_FeatureSet feature) { return s_deviceConfig.m_featureSupported [feature]; }
...
GLEW_EXTERN_C const char * _glew_glx_glXQueryExtensionsString (Display * dpy, int screen);
GLEW_EXTERN_C const char * _glew_glx_glXQueryServerString (Display * dpy, int screen, int name);
GLEW_EXTERN_C const char * _glew_glx_glXGetClientString (Display * dpy, int name);
GLEW_EXTERN_C Display * _glew_glx_glXGetCurrentDisplay ();
GLEW_EXTERN_C GLXFBConfig * _glew_glx_glXGetFBConfigs (Display * dpy, int screen, int * nelements);
GLEW_EXTERN_C GLXFBConfig * _glew_glx_glXChooseFBConfig (Display * dpy, int screen, const int * attrib_list, int * nelements);
GLEW_EXTERN_C int _glew_glx_glXGetFBConfigAttrib (Display * dpy, GLXFBConfig config, int attribute, int * value);
GLEW_EXTERN_C XVisualInfo * _glew_glx_glXGetVisualFromFBConfig (Display * dpy, GLXFBConfig config);
GLEW_EXTERN_C GLXWindow _glew_glx_glXCreateWindow (Display * dpy, GLXFBConfig config, Window win, const int * attrib_list);
GLEW_EXTERN_C void _glew_glx_glXDestroyWindow (Display * dpy, GLXWindow win);
GLEW_EXTERN_C GLXPixmap _glew_glx_glXCreatePixmap (Display * dpy, GLXFBConfig config, Pixmap pixmap, const int * attrib_list);
GLEW_EXTERN_C void _glew_glx_glXDestroyPixmap (Display * dpy, GLXPixmap pixmap);
GLEW_EXTERN_C GLXPbuffer _glew_glx_glXCreatePbuffer (Display * dpy, GLXFBConfig config, const int * attrib_list);
GLEW_EXTERN_C void _glew_glx_glXDestroyPbuffer (Display * dpy, GLXPbuffer pbuf);
GLEW_EXTERN_C void _glew_glx_glXQueryDrawable (Display * dpy, GLXDrawable draw, int attribute, unsigned int * value);
GLEW_EXTERN_C GLXContext _glew_glx_glXCreateNewContext (Display * dpy, GLXFBConfig config, int render_type, GLXContext share_list, Bool direct);
GLEW_EXTERN_C Bool _glew_glx_glXMakeContextCurrent (Display * dpy, GLXDrawable draw, GLXDrawable read, GLXContext ctx);
GLEW_EXTERN_C GLXDrawable _glew_glx_glXGetCurrentReadDrawable ();
GLEW_EXTERN_C int _glew_glx_glXQueryContext (Display * dpy, GLXContext ctx, int attribute, int * value);
GLEW_EXTERN_C void _glew_glx_glXSelectEvent (Display * dpy, GLXDrawable draw, unsigned long event_mask);
GLEW_EXTERN_C void _glew_glx_glXGetSelectedEvent (Display * dpy, GLXDrawable draw, unsigned long * event_mask);
GLEW_EXTERN_C __GLXextFuncPtr _glew_glx_glXGetProcAddress (const GLubyte * procName);
GLEW_EXTERN_C unsigned int _glew_glx_glXGetGPUIDsAMD (unsigned int maxCount, unsigned int * ids);
GLEW_EXTERN_C int _glew_glx_glXGetGPUInfoAMD (unsigned int id, int property, GLenum dataType, unsigned int size, void * data);
GLEW_EXTERN_C unsigned int _glew_glx_glXGetContextGPUIDAMD (GLXContext ctx);
GLEW_EXTERN_C GLXContext _glew_glx_glXCreateAssociatedContextAMD (unsigned int id, GLXContext share_list);
GLEW_EXTERN_C GLXContext _glew_glx_glXCreateAssociatedContextAttribsAMD (unsigned int id, GLXContext share_context, const int * attribList);
GLEW_EXTERN_C Bool _glew_glx_glXDeleteAssociatedContextAMD (GLXContext ctx);
GLEW_EXTERN_C Bool _glew_glx_glXMakeAssociatedContextCurrentAMD (GLXContext ctx);
GLEW_EXTERN_C GLXContext _glew_glx_glXGetCurrentAssociatedContextAMD ();
GLEW_EXTERN_C void _glew_glx_glXBlitContextFramebufferAMD (GLXContext dstCtx, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
GLEW_EXTERN_C GLXContext _glew_glx_glXCreateContextAttribsARB (Display * dpy, GLXFBConfig config, GLXContext share_context, Bool direct, const int * attrib_list);
GLEW_EXTERN_C __GLXextFuncPtr _glew_glx_glXGetProcAddressARB (const GLubyte * procName);
GLEW_EXTERN_C Display * _glew_glx_glXGetCurrentDisplayEXT ();
GLEW_EXTERN_C int _glew_glx_glXQueryContextInfoEXT (Display * dpy, GLXContext context, int attribute, int * value);
GLEW_EXTERN_C GLXContextID _glew_glx_glXGetContextIDEXT (const GLXContext context);
GLEW_EXTERN_C GLXContext _glew_glx_glXImportContextEXT (Display * dpy, GLXContextID contextID);
GLEW_EXTERN_C void _glew_glx_glXFreeContextEXT (Display * dpy, GLXContext context);
GLEW_EXTERN_C void _glew_glx_glXSwapIntervalEXT (Display * dpy, GLXDrawable drawable, int interval);
GLEW_EXTERN_C void _glew_glx_glXBindTexImageEXT (Display * dpy, GLXDrawable drawable, int buffer, const int * attrib_list);
GLEW_EXTERN_C void _glew_glx_glXReleaseTexImageEXT (Display * dpy, GLXDrawable drawable, int buffer);
GLEW_EXTERN_C unsigned int _glew_glx_glXGetAGPOffsetMESA (const void * pointer);
GLEW_EXTERN_C void _glew_glx_glXCopySubBufferMESA (Display * dpy, GLXDrawable drawable, int x, int y, int width, int height);
GLEW_EXTERN_C GLXPixmap _glew_glx_glXCreateGLXPixmapMESA (Display * dpy, XVisualInfo * visual, Pixmap pixmap, Colormap cmap);
GLEW_EXTERN_C Bool _glew_glx_glXQueryCurrentRendererIntegerMESA (int attribute, unsigned int * value);
GLEW_EXTERN_C const char * _glew_glx_glXQueryCurrentRendererStringMESA (int attribute);
GLEW_EXTERN_C Bool _glew_glx_glXQueryRendererIntegerMESA (Display * dpy, int screen, int renderer, int attribute, unsigned int * value);
GLEW_EXTERN_C const char * _glew_glx_glXQueryRendererStringMESA (Display * dpy, int screen, int renderer, int attribute);
GLEW_EXTERN_C Bool _glew_glx_glXReleaseBuffersMESA (Display * dpy, GLXDrawable drawable);
GLEW_EXTERN_C Bool _glew_glx_glXSet3DfxModeMESA (int mode);
GLEW_EXTERN_C void _glew_glx_glXCopyBufferSubDataNV (Display * dpy, GLXContext readCtx, GLXContext writeCtx, GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
GLEW_EXTERN_C void _glew_glx_glXNamedCopyBufferSubDataNV (Display * dpy, GLXContext readCtx, GLXContext writeCtx, GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
GLEW_EXTERN_C void _glew_glx_glXCopyImageSubDataNV (Display * dpy, GLXContext srcCtx, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLXContext dstCtx, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth);
GLEW_EXTERN_C Bool _glew_glx_glXDelayBeforeSwapNV (Display * dpy, GLXDrawable drawable, GLfloat seconds);
GLEW_EXTERN_C unsigned int * _glew_glx_glXEnumerateVideoDevicesNV (Display * dpy, int screen, int * nelements);
GLEW_EXTERN_C int _glew_glx_glXBindVideoDeviceNV (Display * dpy, unsigned int video_slot, unsigned int video_device, const int * attrib_list);
GLEW_EXTERN_C Bool _glew_glx_glXJoinSwapGroupNV (Display * dpy, GLXDrawable drawable, GLuint group);
GLEW_EXTERN_C Bool _glew_glx_glXBindSwapBarrierNV (Display * dpy, GLuint group, GLuint barrier);
GLEW_EXTERN_C Bool _glew_glx_glXQuerySwapGroupNV (Display * dpy, GLXDrawable drawable, GLuint * group, GLuint * barrier);
GLEW_EXTERN_C Bool _glew_glx_glXQueryMaxSwapGroupsNV (Display * dpy, int screen, GLuint * maxGroups, GLuint * maxBarriers);
GLEW_EXTERN_C Bool _glew_glx_glXQueryFrameCountNV (Display * dpy, int screen, GLuint * count);
GLEW_EXTERN_C Bool _glew_glx_glXResetFrameCountNV (Display * dpy, int screen);
GLEW_EXTERN_C int _glew_glx_glXBindVideoCaptureDeviceNV (Display * dpy, unsigned int video_capture_slot, GLXVideoCaptureDeviceNV device);
GLEW_EXTERN_C GLXVideoCaptureDeviceNV * _glew_glx_glXEnumerateVideoCaptureDevicesNV (Display * dpy, int screen, int * nelements);
GLEW_EXTERN_C void _glew_glx_glXLockVideoCaptureDeviceNV (Display * dpy, GLXVideoCaptureDeviceNV device);
GLEW_EXTERN_C int _glew_glx_glXQueryVideoCaptureDeviceNV (Display * dpy, GLXVideoCaptureDeviceNV device, int attribute, int * value);
GLEW_EXTERN_C void _glew_glx_glXReleaseVideoCaptureDeviceNV (Display * dpy, GLXVideoCaptureDeviceNV device);
GLEW_EXTERN_C int _glew_glx_glXGetVideoDeviceNV (Display * dpy, int screen, int numVideoDevices, GLXVideoDeviceNV * pVideoDevice);
GLEW_EXTERN_C int _glew_glx_glXReleaseVideoDeviceNV (Display * dpy, int screen, GLXVideoDeviceNV VideoDevice);
GLEW_EXTERN_C int _glew_glx_glXBindVideoImageNV (Display * dpy, GLXVideoDeviceNV VideoDevice, GLXPbuffer pbuf, int iVideoBuffer);
GLEW_EXTERN_C int _glew_glx_glXReleaseVideoImageNV (Display * dpy, GLXPbuffer pbuf);
GLEW_EXTERN_C int _glew_glx_glXSendPbufferToVideoNV (Display * dpy, GLXPbuffer pbuf, int iBufferType, unsigned long * pulCounterPbuffer, GLboolean bBlock);
GLEW_EXTERN_C int _glew_glx_glXGetVideoInfoNV (Display * dpy, int screen, GLXVideoDeviceNV VideoDevice, unsigned long * pulCounterOutputPbuffer, unsigned long * pulCounterOutputVideo);
GLEW_EXTERN_C Bool _glew_glx_glXGetSyncValuesOML (Display * dpy, GLXDrawable drawable, int64_t * ust, int64_t * msc, int64_t * sbc);
GLEW_EXTERN_C Bool _glew_glx_glXGetMscRateOML (Display * dpy, GLXDrawable drawable, int32_t * numerator, int32_t * denominator);
GLEW_EXTERN_C int64_t _glew_glx_glXSwapBuffersMscOML (Display * dpy, GLXDrawable drawable, int64_t target_msc, int64_t divisor, int64_t remainder);
GLEW_EXTERN_C Bool _glew_glx_glXWaitForMscOML (Display * dpy, GLXDrawable drawable, int64_t target_msc, int64_t divisor, int64_t remainder, int64_t * ust, int64_t * msc, int64_t * sbc);
GLEW_EXTERN_C Bool _glew_glx_glXWaitForSbcOML (Display * dpy, GLXDrawable drawable, int64_t target_sbc, int64_t * ust, int64_t * msc, int64_t * sbc);
GLEW_EXTERN_C void _glew_glx_glXCushionSGI (Display * dpy, Window window, float cushion);
GLEW_EXTERN_C Bool _glew_glx_glXMakeCurrentReadSGI (Display * dpy, GLXDrawable draw, GLXDrawable read, GLXContext ctx);
GLEW_EXTERN_C GLXDrawable _glew_glx_glXGetCurrentReadDrawableSGI ();
GLEW_EXTERN_C int _glew_glx_glXSwapIntervalSGI (int interval);
GLEW_EXTERN_C int _glew_glx_glXGetVideoSyncSGI (unsigned int * count);
GLEW_EXTERN_C int _glew_glx_glXWaitVideoSyncSGI (int divisor, int remainder, unsigned int * count);
GLEW_EXTERN_C Bool _glew_glx_glXAssociateDMPbufferSGIX (Display * dpy, GLXPbufferSGIX pbuffer, DMparams * params, DMbuffer dmbuffer);
GLEW_EXTERN_C int _glew_glx_glXGetFBConfigAttribSGIX (Display * dpy, GLXFBConfigSGIX config, int attribute, int * value);
GLEW_EXTERN_C GLXFBConfigSGIX * _glew_glx_glXChooseFBConfigSGIX (Display * dpy, int screen, int * attrib_list, int * nelements);
GLEW_EXTERN_C GLXPixmap _glew_glx_glXCreateGLXPixmapWithConfigSGIX (Display * dpy, GLXFBConfigSGIX config, Pixmap pixmap);
GLEW_EXTERN_C GLXContext _glew_glx_glXCreateContextWithConfigSGIX (Display * dpy, GLXFBConfigSGIX config, int render_type, GLXContext share_list, Bool direct);
GLEW_EXTERN_C XVisualInfo * _glew_glx_glXGetVisualFromFBConfigSGIX (Display * dpy, GLXFBConfigSGIX config);
GLEW_EXTERN_C GLXFBConfigSGIX _glew_glx_glXGetFBConfigFromVisualSGIX (Display * dpy, XVisualInfo * vis);
GLEW_EXTERN_C GLXHyperpipeNetworkSGIX * _glew_glx_glXQueryHyperpipeNetworkSGIX (Display * dpy, int * npipes);
GLEW_EXTERN_C int _glew_glx_glXHyperpipeConfigSGIX (Display * dpy, int networkId, int npipes, GLXHyperpipeConfigSGIX * cfg, int * hpId);
GLEW_EXTERN_C GLXHyperpipeConfigSGIX * _glew_glx_glXQueryHyperpipeConfigSGIX (Display * dpy, int hpId, int * npipes);
GLEW_EXTERN_C int _glew_glx_glXDestroyHyperpipeConfigSGIX (Display * dpy, int hpId);
GLEW_EXTERN_C int _glew_glx_glXBindHyperpipeSGIX (Display * dpy, int hpId);
GLEW_EXTERN_C int _glew_glx_glXQueryHyperpipeBestAttribSGIX (Display * dpy, int timeSlice, int attrib, int size, void * attribList, void * returnAttribList);
GLEW_EXTERN_C int _glew_glx_glXHyperpipeAttribSGIX (Display * dpy, int timeSlice, int attrib, int size, void * attribList);
GLEW_EXTERN_C int _glew_glx_glXQueryHyperpipeAttribSGIX (Display * dpy, int timeSlice, int attrib, int size, void * returnAttribList);
GLEW_EXTERN_C GLXPbufferSGIX _glew_glx_glXCreateGLXPbufferSGIX (Display * dpy, GLXFBConfigSGIX config, unsigned int width, unsigned int height, int * attrib_list);
GLEW_EXTERN_C void _glew_glx_glXDestroyGLXPbufferSGIX (Display * dpy, GLXPbufferSGIX pbuf);
GLEW_EXTERN_C int _glew_glx_glXQueryGLXPbufferSGIX (Display * dpy, GLXPbufferSGIX pbuf, int attribute, unsigned int * value);
GLEW_EXTERN_C void _glew_glx_glXSelectEventSGIX (Display * dpy, GLXDrawable drawable, unsigned long mask);
GLEW_EXTERN_C void _glew_glx_glXGetSelectedEventSGIX (Display * dpy, GLXDrawable drawable, unsigned long * mask);
GLEW_EXTERN_C void _glew_glx_glXBindSwapBarrierSGIX (Display * dpy, GLXDrawable drawable, int barrier);
GLEW_EXTERN_C Bool _glew_glx_glXQueryMaxSwapBarriersSGIX (Display * dpy, int screen, int * max);
GLEW_EXTERN_C void _glew_glx_glXJoinSwapGroupSGIX (Display * dpy, GLXDrawable drawable, GLXDrawable member);
GLEW_EXTERN_C int _glew_glx_glXBindChannelToWindowSGIX (Display * display, int screen, int channel, Window window);
GLEW_EXTERN_C int _glew_glx_glXChannelRectSGIX (Display * display, int screen, int channel, int x, int y, int w, int h);
GLEW_EXTERN_C int _glew_glx_glXQueryChannelRectSGIX (Display * display, int screen, int channel, int * dx, int * dy, int * dw, int * dh);
GLEW_EXTERN_C int _glew_glx_glXQueryChannelDeltasSGIX (Display * display, int screen, int channel, int * x, int * y, int * w, int * h);
GLEW_EXTERN_C int _glew_glx_glXChannelRectSyncSGIX (Display * display, int screen, int channel, GLenum synctype);
GLEW_EXTERN_C GLXVideoSourceSGIX _glew_glx_glXCreateGLXVideoSourceSGIX (Display * display, int screen, VLServer server, VLPath path, int nodeClass, VLNode drainNode);
GLEW_EXTERN_C void _glew_glx_glXDestroyGLXVideoSourceSGIX (Display * dpy, GLXVideoSourceSGIX glxvideosource);
GLEW_EXTERN_C Status _glew_glx_glXGetTransparentIndexSUN (Display * dpy, Window overlay, Window underlay, long * pTransparentIndex);
