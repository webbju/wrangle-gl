...
WGLBoolean wglwQueryCapabilities (WGLCapabilities *capabilities);

const WGLCapabilities *wglwGetCapabilities ();

WGLBoolean wglwSetCapabilities (const WGLCapabilities *capabilities);
