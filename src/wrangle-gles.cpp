...
void glBlendEquationEXT (GLenum mode)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glBlendEquationEXT)
  {
    deviceState->m_glBlendEquationEXT (mode);
  }
}
...
void glUseShaderProgramEXT (GLenum type, GLuint program)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glUseShaderProgramEXT)
  {
    deviceState->m_glUseShaderProgramEXT (type, program);
  }
}
...
void glActiveProgramEXT (GLuint program)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glActiveProgramEXT)
  {
    deviceState->m_glActiveProgramEXT (program);
  }
}
...
GLuint glCreateShaderProgramEXT (GLenum type, const GLchar * string)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glCreateShaderProgramEXT)
  {
    return deviceState->m_glCreateShaderProgramEXT (type, string);
  }
  return ((GLuint)0);
}
...
GLenum glPathGlyphIndexRangeNV (GLenum fontTarget, const void * fontName, GLbitfield fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint baseAndCount[2])
{
  ...
  {
    return deviceState->m_glPathGlyphIndexRangeNV (fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount[2]);
  }
  return ((GLenum)0);
}
...
void glPathColorGenNV (GLenum color, GLenum genMode, GLenum colorFormat, const GLfloat * coeffs)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glPathColorGenNV)
  {
    deviceState->m_glPathColorGenNV (color, genMode, colorFormat, coeffs);
  }
}
...
void glPathTexGenNV (GLenum texCoordSet, GLenum genMode, GLint components, const GLfloat * coeffs)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glPathTexGenNV)
  {
    deviceState->m_glPathTexGenNV (texCoordSet, genMode, components, coeffs);
  }
}
...
void glPathFogGenNV (GLenum genMode)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glPathFogGenNV)
  {
    deviceState->m_glPathFogGenNV (genMode);
  }
}
...
void glGetPathColorGenivNV (GLenum color, GLenum pname, GLint * value)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glGetPathColorGenivNV)
  {
    deviceState->m_glGetPathColorGenivNV (color, pname, value);
  }
}
...
void glGetPathColorGenfvNV (GLenum color, GLenum pname, GLfloat * value)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glGetPathColorGenfvNV)
  {
    deviceState->m_glGetPathColorGenfvNV (color, pname, value);
  }
}
...
void glGetPathTexGenivNV (GLenum texCoordSet, GLenum pname, GLint * value)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glGetPathTexGenivNV)
  {
    deviceState->m_glGetPathTexGenivNV (texCoordSet, pname, value);
  }
}
...
void glGetPathTexGenfvNV (GLenum texCoordSet, GLenum pname, GLfloat * value)
{
  ...
  const glew::gles::DeviceState *deviceState = glew::gles::GetDeviceState ();
  if (deviceState && deviceState->m_glGetPathTexGenfvNV)
  {
    deviceState->m_glGetPathTexGenfvNV (texCoordSet, pname, value);
  }
}
